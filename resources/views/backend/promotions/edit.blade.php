    ...
    <div class="">
        <div class="page-title">
            <div class="title_left">
                <h3>Form <small>Edit promotions</small></h3>
            </div>
        </div>
        ...
        <div class="row">
            <div class="x_content">
                {{ Form::open
                    ([
                        'method' => 'PUT',
                        'route' => ['promotion.update', $promotion->id],
                        'files' => true,
                    ...
                    <div class="col-md-9 col-sm-9 col-md-offset-9 form-group has-feedback style-form" style="margin-left: 11em;">
                        {{ Form::number('percent', $promotion->percent, ['class' => 'form-control has-feedback-left', 'id' => 'inputSuccess2', 'placeholder' => 'Import percent', 'style' => 'padding-left:4em']) }}
