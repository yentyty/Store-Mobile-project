    ...
    <div class="">
        <div class="page-title">
            <div class="title_left">
                <h3>Form <small>Edit factory</small></h3>
            </div>
        </div>
        ...
        <div class="row">
            <div class="x_content">
                {{ Form::open
                    ([
                        'method' => 'PUT',
                        'route' => ['factory.update', $factory->id],
                        'files' => true,
                    ...
                    <div class="col-md-9 col-sm-9 col-md-offset-9 form-group has-feedback style-form" style="margin-left: 11em;">
                        {{ Form::text('name', $factory->name, ['class' => 'form-control has-feedback-left', 'id' => 'inputSuccess2', 'placeholder' => 'Import name factory', 'style' => 'padding-left:5em']) }}
