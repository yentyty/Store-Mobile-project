    ...
    <div class="">
        <div class="page-title">
            <div class="title_left">
                <h3>Form <small>Create introduce</small></h3>
            </div>
        </div>
                        ...
                        <div class="col-md-12 text-center mt-3">
                            <div class="row">
                                ...
                                <div class="col-lg-3 text-center">
                                    {{ Form::button('<i class="fa fa-fw fa-lg fa-check-circle"></i> Update', ['type' => 'submit', 'class' => 'btn btn-primary', 'style' => 'margin-right:-12em;'] ) }}
                                </div>
                                <div class="col-lg-3 text-center">
                                    <a
