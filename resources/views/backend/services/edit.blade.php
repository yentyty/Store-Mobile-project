    ...
    <div class="">
        <div class="page-title">
            <div class="title_left">
                <h3>Form <small>Edit Service</small></h3>
            </div>
        </div>
                ...
                {{ Form::open
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                            {{ Form::text('name', $service->name, ['class' => 'form-control resizable_textarea form-control', 'placeholder' => 'Import name']) }}
                        </div>
                        @if ($errors->has('name'))
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                            {{ Form::textarea('description', $service->description, ['class' => 'form-control resizable_textarea form-control', 'placeholder' => 'Import description', 'rows' => '4', 'cols' => '50']) }}
                        </div>
                    ...
                    <div class="form-group" style="width:60em;">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                            @if(!empty($service->icon))
                                <img src="uploads/images/services/{{ $service->icon}}" width="10%" alt="Icon" id="img">
                            @else
                                <img src="" width="10%" alt="Icon" id="img" style="display: none;">
                            @endif
                    ...
                    <div class="form-group">
                        <div class="col-md-12 text-center mt-3" style="margin-top: 3em;">
                            {{ Form::button('<i class="fa fa-fw fa-lg fa-check-circle"></i> Edit', ['type' => 'submit', 'class' => 'btn btn-primary', 'style' => 'margin-right:5em;'] ) }}
                            <a
