    ...
    <div class="">
        <div class="page-title">
            <div class="title_left">
                <h3>Form <small>Create Logo</small></h3>
            </div>
        </div>
            ...
            <div class="x_content">
                {{ Form::open
                    ...
                    <div class="x_content" style="text-align:center;">
                        <img src="" width="20%" alt="Image Cover" id="img" style="display: none;">
                    </div>
                    <div class="form-group">
                        {{ Form::label('image', 'Logo Image *: ', ['class' => 'control-label col-md-3 col-sm-3 col-xs-12']) }}
                        <br>
